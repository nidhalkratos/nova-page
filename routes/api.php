...
Route::get(
    "/nova-api/nova-page/count",
    PageResourceCountController::class . "@show",
);
Route::get(
...
Route::delete(
    "/nova-api/nova-page/{resourceId}/field/{field}",
    PageFieldDestroyController::class . "@handle",
);

Route::get(
    "/nova-api/nova-option",
    OptionResourceIndexController::class . "@handle",
);
Route::get(
    "/nova-api/nova-option/count",
...
Route::delete(
    "/nova-api/nova-option/{resourceId}/field/{field}",
